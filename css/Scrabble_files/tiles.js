...
//let renderTile = function() {
    //make node 
   // <svg width="400" height="180">
  // newtile = get("svg");
   //svg.rect x="50" y="20" rx="20" ry="20" width="150" height="150" style="fill:red;stroke:black;stroke-width:5;opacity:0.5" />
...
$(document).ready(function(){
    ...
    $(".snapTarget").droppable({
        drop: function(e, ui){console.log($(this).index()); console.log(ui.draggable.attr("alt"))}
    });
